...
public static class OrderMapper
{
    public static OrderDocument ToDocument(CreateOrderRequest request)
    {
        ...
        return new OrderDocument
        {
            ...
            CashPaymentType = request.CashPaymentType,
            CashAmountProvided = request.CashAmountProvided,
            EstimatedChange = request.EstimatedChange,
            Notes = request.Notes,
            CreatedAt = now,
            UpdatedAt = now
        };
    ...
    public static OrderResponse ToResponse(OrderDocument document)
    {
        return new OrderResponse
        {
            ...
            CashPaymentType = document.CashPaymentType,
            CashAmountProvided = document.CashAmountProvided,
            EstimatedChange = document.EstimatedChange,
